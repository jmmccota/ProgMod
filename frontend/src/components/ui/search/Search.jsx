...
import { Divider, Chip, Button, Card, CardActions, CardContent, CircularProgress } from '@material-ui/core';
                ...
                <Grid fluid>
                  <Col mdOffset={8} xs={12} md={4}>
                    <Row>
                      ...
                      <Col xs={12} md={5}>
                        <Button variant="raised" color="primary" style={{ width: "100%" }} disabled={pristine || submitting} onClick={handleSubmit(this.pesquisar)}>Pesquisar</Button>
                      </Col>
                      <Col xs={12} md={5}>
